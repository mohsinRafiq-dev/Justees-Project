        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <a href="https://www.tiktok.com/@justees" target="_blank" rel="noopener noreferrer" className={`${isDark ? 'hover:text-cyan-400' : 'hover:text-cyan-600'} transition-colors flex items-center gap-2`}>
