        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2">
              <a href="https://wa.me/923291526285" target="_blank" rel="noopener noreferrer" className={`${isDark ? 'hover:text-green-400' : 'hover:text-green-600'} transition-colors flex items-center gap-2`}>
              ...
              <a href="https://instagram.com/justees.official" target="_blank" rel="noopener noreferrer" className={`${isDark ? 'hover:text-pink-400' : 'hover:text-pink-600'} transition-colors flex items-center gap-2`}>
              ...
              <a href="https://www.tiktok.com/@justees_official" target="_blank" rel="noopener noreferrer" className={`${isDark ? 'hover:text-cyan-400' : 'hover:text-cyan-600'} transition-colors flex items-center gap-2`}>
