            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="hidden lg:flex items-center space-x-1">
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  href="https://wa.me/923291526285?text=Hi%20Justees!%20I%20have%20a%20question%20about%20your%20products."
                  target="_blank"
                ...
                <motion.a
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  href="https://www.tiktok.com/@justees_official"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className={`md:hidden ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-t max-h-[calc(100vh-64px)] overflow-y-auto`}>
            <div className="px-4 py-4 space-y-4">
              ...
              <div className={`flex items-center justify-center space-x-6 py-4 border-t border-b ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                <a href="https://wa.me/923291526285?text=Hi%20Justees!%20I%20have%20a%20question%20about%20your%20products." target="_blank" rel="noopener noreferrer" className={`flex items-center justify-center ${isDark ? 'text-gray-300 hover:text-green-400' : 'text-gray-700 hover:text-green-600'}`} aria-label="WhatsApp">
                ...
                <a href="https://www.tiktok.com/@justees_official" target="_blank" rel="noopener noreferrer" className={`flex items-center justify-center ${isDark ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-700 hover:text-cyan-600'}`} aria-label="TikTok">
